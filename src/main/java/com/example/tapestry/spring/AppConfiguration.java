package com.example.tapestry.spring;
...
@Configuration
@ComponentScan({ "com.example.tapestry" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.example.tapestry");
                servletContext.setInitParameter("tapestry.development-modules", "com.example.tapestry.services.DevelopmentModule");
